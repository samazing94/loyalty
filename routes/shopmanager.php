...
Route::prefix('shopmanager')->group(function () {
...
//shop list
Route::group(['prefix' => 'shopmanager/shop', 'middleware' => 'auth'], function()
{
...
Route::group(['prefix' => 'shopmanager/customer', 'middleware' => 'auth'], function()
{
...
//point mgt
Route::group(['prefix' => 'shopmanager/offerlist', 'middleware' => 'auth'], function(){
...
Route::group(['prefix' => 'shopmanager/orders', 'middleware' => 'auth'], function(){
...
//report
// Route::group(['prefix' => 'shopmanager/report', 'middleware' => 'auth'], function(){
