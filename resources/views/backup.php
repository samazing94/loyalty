...
<?php
  ...
  if(!$conn)
  {
    ...
    $sql1 = "SELECT * FROM customersinfo WHERE mobile_number = $mobile_number";
    ...
    else //if(!$rowcount)
    {
      ...
      else //if ($sublength > 1 && $sublength <= 3)
      {
        ...
        else 
        {
          ...
          $sql2 = "INSERT INTO smslog (hotkey, msisdn, sms_body, status, reply_body ) VALUES ('$hotkey', '$msisdn', '$sms_body', $status, '$reply_body')";
          $sql = "INSERT INTO customersinfo (mobile_number, first_name, last_name, dob, profession, location) VALUES ('$mobile_number', '$firstname', '$lastname', '$dob', '$profession','$location')";
...
<p> Name: </p> {{ customers->firstname }}
  <br>
  <p> Mobile No: </p> {{ customers->mobile_no }}
  <br>
